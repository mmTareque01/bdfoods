    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header visible-xs">
                ...
                <a class="navbar-brand" href="#"><h2>BD Foods</h2></a>
            </div><!-- navbar-header -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav " >
                ...
                ><a href="index.php?page=contact">Contacts</a></li>
                <li><a href="index.php#chefs">Cooks</a></li>
                <li <?php if(isset($_GET['page'])&&$_GET['page']=='reservation') { echo "class='active'"; } ?>><a href="index.php?page=reservation">Reservation</a></li>
                ...
                Cart :</strong> &nbsp;<?= $_SESSION['sum'] ?> BDT</a></li>
