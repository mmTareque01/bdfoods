...
<div id="special-offser" class="parallax pricing">
    ...
    <button class="btn btn-danger" onclick="addToCard(<?php echo "$f->id,$f->price,'$f->name','$f->image'"; ?>)" >Order now</button>
                            <div class="clearfix"></div>
                        </div>
                        <!--price tag-->
                        <span class="hot-tag br-red" style="font-size:14px;"><?php echo $f->price; ?>BDT</span>
                        <div class="clearfix"></div>
                    </div>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button  class="btn btn-success" onclick="saveToCard()" >Add to cart</button>
