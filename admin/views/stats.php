				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-9 widget-right">
							...
							<div class="text-muted">Total <?php echo $stats['money']; ?> BDT </div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-9 widget-right">
							...
							<div class="text-muted"><?php echo $stats['orders']; ?> Orders</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-9 widget-right">
							...
							<div class="text-muted"><?php echo $stats['reservations']; ?> Reservations</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-9 widget-right">
							...
							<div class="text-muted"><?php echo $stats['foods']; ?> Products</div>
						</div>
					</div>
				</div>
			</div>
