		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<button class="btn-lg btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add menu</button>
						<table data-toggle="table"    data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="Име" data-sort-order="desc">
						    <thead>
						    <tr>
						  						        <th data-field="Име" data-sortable="true">Name</th>
						           <th data-field="Description"  data-sortable="true">Description</th>
						        <th data-field="Снимка" data-sortable="true">Photo</th>
						    ...
						    <td>
						    	...
						    	<a href="index.php?page=menus&action=delete&id=<?php echo $menu->id; ?>"><button class="btn btn-danger" >Delete</button></a>
						    	</td>
						    </tr>
						    <?php } ?>  
						    </tbody>
