...
error_reporting(1);
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Reservations
			</h2>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table data-toggle="table"    data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr> <th data-field="datetime" data-sortable="true">Date and time</th>
						  						        <th data-field="name" data-sortable="true">Name</th>
						  						         <th data-field="phone" data-sortable="true">Phone</th>
						  						          <th data-field="number" data-sortable="true">Number of guests</th>
						  						          <th>Status</th>
						  						           <th></th>
						    ...
						    <?php }else{ ?>
					<label class="label label-success">Reserved</label>

						    <?php } ?></td>

						    <td>
						    <?php if($ad->status==0){ ?>
						        <a href="index.php?page=reservations&action=reserve&id=<?php echo $ad->id; ?>"><button class="btn btn-success" >Book</button></a>
						        <?php } ?>

						         <a href="index.php?page=reservations&action=delete&id=<?php echo $ad->id; ?>"><button class="btn btn-danger" >Delete</button></a>
						    </td>
